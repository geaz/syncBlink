...
namespace SyncBlink.Desktop
{
    ...
    internal static class Bindings
    {
        ...
        [DllImport(DllFile, EntryPoint = "syncblink_api_init")]
        ...
        [DllImport(DllFile, EntryPoint = "syncblink_api_start")]
        internal extern static IntPtr Start(IntPtr syncBlinkApi);

        [DllImport(DllFile, EntryPoint = "syncblink_api_stop")]
        internal extern static IntPtr Stop(IntPtr syncBlinkApi);

        [DllImport(DllFile, EntryPoint = "syncblink_api_on_freq")]
