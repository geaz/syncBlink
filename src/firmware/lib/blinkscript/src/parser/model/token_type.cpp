...
namespace SyncBlink
{
    std::map<TokenType, size_t> TokenPrecedences = {{TokenType::OR, 1},       {TokenType::AND, 2},        {TokenType::EQUAL, 3},
                                                 ...
                                                 {TokenType::PLUS, 4},        {TokenType::MINUS, 4},      {TokenType::MODULO, 5}, 
                                                 {TokenType::STAR, 5},        {TokenType::SLASH, 5},      {TokenType::LEFT_PAREN, 6},
                                                 {TokenType::LEFT_BRACKET, 7}};
